...
public class WebController {
    ...
    public Result login(@RequestBody Account account) {
        ...
        if ("DEAN".equals(account.getRole())) {
            return Result.success(deanService.login(account));
        }
        if ("SECRETARY".equals(account.getRole())) {
            return Result.success(secretaryService.login(account));
        }
        return Result.success();
    }
    ...
    public Result updatePassword(@RequestBody Account account) {
        ...
        if ("DEAN".equals(account.getRole())) {
            deanService.updatePassword(account);
        }
        if ("SECRETARY".equals(account.getRole())) {
            secretaryService.updatePassword(account);
        }
        if ("TEACHER".equals(account.getRole())) {
