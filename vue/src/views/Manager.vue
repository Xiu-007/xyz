    ...
    <div style="height: 60px; background-color: #afcaf5; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px">毕业论文管理系统</div>
        </div>
      </div>
      ...
      <div style="width: 200px; border-right: 1px solid #ddd; min-height: calc(100vh - 60px)">
        ...
        >
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item index="/systemlogs" v-if="data.user.role === 'ADMIN'"><el-icon><ChromeFilled /></el-icon><span>系统日志</span></el-menu-item>
            <el-menu-item index="/documentupload" v-if="data.user.role === 'STUDENT'"><el-icon><Document /></el-icon><span>文档上传</span></el-menu-item>
            <el-menu-item index="/teacherAssignment" v-if="data.user.role === 'SECRETARY'"><el-icon><Document /></el-icon><span>教师分配</span></el-menu-item>
            <el-menu-item index="/teacherAudit" v-if="data.user.role === 'TEACHER'"><el-icon><Document /></el-icon><span>教师审核</span></el-menu-item>
            <el-menu-item index="/deanAudit" v-if="data.user.role === 'DEAN'"><el-icon><Document /></el-icon><span>院长审核</span></el-menu-item>
          </el-sub-menu>
          <el-sub-menu index="3" v-if="data.user.role === 'ADMIN'">
            ...
            <el-menu-item index="/dean"><el-icon><User /></el-icon><span>主管教学副院长信息</span></el-menu-item>
            <el-menu-item index="/secretary"><el-icon><User /></el-icon><span>教务秘书信息</span></el-menu-item>
          ...
          <el-menu-item v-if="data.user.role === 'DEAN'" index="/dperson"><el-icon><User /></el-icon><span>个人资料</span></el-menu-item>
          <el-menu-item v-if="data.user.role === 'SECRETARY'" index="/seperson"><el-icon><User /></el-icon><span>个人资料</span></el-menu-item>
