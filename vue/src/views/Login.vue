<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #1450aa">欢迎登录毕业论文管理系统</div>
      <el-form :model="data.form"  ref="formRef" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select size="large" style="width: 100%" v-model="data.form.role">
            ...
            <el-option value="DEAN" label="主管教学副院长"></el-option>
            <el-option value="SECRETARY" label="教务秘书"></el-option>
